...
layout: post
comments: true
title: Using Github gists as a file backup service 🤔
description: I found myself creating backups of markdown files on github gists, so I write a script
tags: python 
---


So I generate a lot of files, generally because I write a lot ([almost 60 TILs]()) and sometimes I found myself creating a backup of unfinished stuff on github as a secret gist.
